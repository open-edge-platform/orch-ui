...
export const telemetryMetricsGroup1: infra.TelemetryMetricsGroupRead = {
...
export const telemetryMetricsGroup2: infra.TelemetryMetricsGroupRead = {
...
export const telemetryMetricsGroup3: infra.TelemetryMetricsGroupRead = {
