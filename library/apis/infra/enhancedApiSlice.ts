...
import { infraApi as infraSlice } from "./apiSlice";
import * as infra from "./infra";
import { addTagTypes } from "./infra";

// FIXME: why are we adding custom tags here? rework to rely on the autogenerated ones
const RegionTag: (typeof addTagTypes)[number] = "RegionService";
const RegionListTag = "RegionList";
const SiteTag: (typeof addTagTypes)[number] = "SiteService";
const SiteListTag = "SiteList";
const OUListTag = "OUList";
const HostTag: (typeof addTagTypes)[number] = "HostService";
const HostListTag = "HostList";
const ScheduleTag: (typeof addTagTypes)[number] = "ScheduleService";
const ScheduleListTag = "ScheduleList";
const OSTag: (typeof addTagTypes)[number] = "OperatingSystemService";
const OSListTag = "OSList";
const WorkloadTag: (typeof addTagTypes)[number] = "WorkloadService";
const WorkloadListTag = "WorkloadList";
const InstanceListTag = "InstanceList";
const LocalAccountListTag = "LocalAccountList";
const LocalAccountTag: (typeof addTagTypes)[number] = "LocalAccountService";
